...
export class NotifierService {
    ...
    showSuccess(message: Message) {
        this._snackBar.open(message.detail, '',
            {
                panelClass: 'panel-snackbar-success',
                duration: message.life?message.life: 6000,
    ...
    showLog(message:any,type?:string){
        if (type === 'error') {
            console.error(message);
        } else if (type === 'log' || type === null) {
            console.log(message);
        }
    }
...
@Component({
    ...
    template: `
        <div #container [attr.id]="message.id" class="ui-toast-message ui-shadow"
             ...
             (mouseenter)="onMouseEnter()" (mouseleave)="onMouseLeave()" role="alert" aria-live="assertive"
             aria-atomic="true">
            <div class="ui-toast-message-content">
                <a tabindex="0" class="ui-toast-close-icon pi pi-times" (click)="onCloseIconClick($event)"
                   (keydown.enter)="onCloseIconClick($event)" *ngIf="message.closable !== false"></a>
...
@Component({
    ...
    template: `
        <div #container [ngClass]="{'ui-toast ui-widget': true,
            ...
            <p-toastItem *ngFor="let msg of messages; let i=index" [message]="msg" [index]="i"
                         (onClose)="onMessageClose($event)"
                         [template]="template" @toastAnimation (@toastAnimation.start)="onAnimationStart($event)"
                         [showTransformOptions]="showTransformOptions" [hideTransformOptions]="hideTransformOptions"
                         [showTransitionOptions]="showTransitionOptions"
                         [hideTransitionOptions]="hideTransitionOptions"></p-toastItem>
        </div>
    `,
    animations: [
...
@NgModule({
    ...
    providers: [MessageService, NotifierService]
})
