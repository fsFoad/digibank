...
export class CardBoardPayaComponent implements OnInit {
  ...
  fsList: {
    ...
    dateEffective: number, status: string, registrar: string, registrationDate: number,ibon:string,economicCode:number,
...

    {
      ...
      'registrationDate': 13990812,ibon:'IR830120000000000055771565',economicCode:4872,remittancesNumber:'1',
    ...
    },
    {
      ...
      'registrationDate': 14000205,ibon:'IR895870000000000055662389',economicCode:6924,remittancesNumber:'5',
      ...
      'registrationDate': 14000501,ibon:'IR895870000000000058566589',economicCode:5485,remittancesNumber:'3',
