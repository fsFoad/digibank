...
export class BillingBonCardComponent implements OnInit {
  ...
  fsList: {
    ...
    {
      'accountNumber': '240-1000000589-25', 'history': '1404/04/15',
      'branchName': 'دولت', 'yektaCode': '10000022',
      'dateDue': '423523452', 'transactionDes': 'پوز', 'check': '2222589',
      'dateDone': '1404/04/30', 'doc': '5666', 'amount': 23000000000, 'creditor': '10000000000'
    },
    {
      'accountNumber': '340-1000000145-65', 'history': '1404/04/25'
      , 'branchName': 'بازار', 'yektaCode': '10000022',
      'dateDue': '23423443', 'transactionDes': 'خودپرداز', 'check': '2222590',
      'dateDone': '1404/04/29', 'doc': '5667', 'amount': 110000000000, 'creditor': '81000000000'
    },
    {
      'accountNumber': '340-1000000189-26', 'history': '1404/04/30'
      , 'branchName': 'تجریش', 'yektaCode': '10000022',
      'dateDue': '4542234', 'transactionDes': 'برداشت نقدی', 'check': '2222591',
      'dateDone': '1404/04/06', 'doc': '5668', 'amount': 95000000000, 'creditor': '52000000000'
    },
    {
      'accountNumber': '440-1006580523-01', 'history': '1404/05/09'
      , 'branchName': 'دولت', 'yektaCode': '10000022',
      'dateDue': '456456345', 'transactionDes': 'انتقال وجه', 'check': '2222592',
      'dateDone': '1404/05/24', 'doc': '5669', 'amount': 51000000000, 'creditor': '23000000000'
    },
    // {
