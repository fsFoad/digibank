    ...
    template: `
        <div *ngIf="maskVisible" [class]="maskStyleClass"
            ...
            <div #container [ngClass]="{'p-dialog p-component':true, 'p-dialog-rtl':rtl,'p-dialog-draggable':draggable,'p-dialog-resizable':resizable, 'p-dialog-maximized': maximized}"
                ...
                <div #content  [ngStyle]="contentStyle" [class]="contentStyleClass">
<!--                    remove this style from source for customization-->
...
export class CustomDialog implements AfterContentInit,OnDestroy {
...
//     exports: [CustomDialog,SharedModule],
