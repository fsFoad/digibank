import {
  ...
  ViewChild, ChangeDetectorRef, TemplateRef, ContentChildren, QueryList, NgZone, ChangeDetectionStrategy
} from '@angular/core';
...
export class Calendar implements OnInit, OnDestroy, ControlValueAccessor {
  ...
  @Input() placeholder: string = '9999/99/99';
  ...
  updateModel(value) {
    ...
    if (this.dataType == 'date') {
      ...
      if (this.isSingleSelection()) {
        this.onModelChange(this.formatDateTime(this.value).split('/').join(''));
      } else {
